...
async def test_create_post_expired_token(
    ...
    mocker.patch(
        "socialapi.security.access_token_expire_minutes",
        return_value=-1
    )
...
async def test_create_comment(
    async_client: AsyncClient, created_post: dict, logged_in_token: str, registered_user: dict
) -> None:
    body = "Test Comment"
...
async def test_get_comments_on_post(
    ...
    response = await async_client.get(f"/post/{created_comment['post_id']}/comments")
